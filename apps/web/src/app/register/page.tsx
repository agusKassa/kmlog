...
export const metadata = { title: 'KMLog — Crear cuenta' }

export default function RegisterPage() {
  return (
    <div className="flex h-screen overflow-hidden">
      {/* ── Left: atmospheric panel (igual que login) ── */}
      <div
        className="relative hidden flex-1 items-center justify-center overflow-hidden border-r border-[#3c3330]/60 lg:flex"
      ...
      >
        ...
        <div
          ...
          style={{ border: '1px solid transparent', borderTopColor: 'rgba(245,158,11,0.28)', borderRightColor: 'rgba(245,158,11,0.08)', animation: 'ring-spin 14s linear infinite' }}
        />

        <div className="absolute" style={{ width: '520px', height: '520px', animation: 'ring-spin 160s linear infinite' }}>
        ...
        <div className="relative z-10 px-12 text-center">
          ...
          <p className="font-body mx-auto max-w-[280px] text-[1.2rem] italic leading-[1.8] text-stone-400">
            Tu historia comienza aquí.<br />
            Elegí tu rol y unite<br />
            a la campaña.
          </p>

          <div className="mx-auto mt-6 flex max-w-[240px] items-center gap-4">
            <div className="h-px flex-1" style={{ background: 'linear-gradient(to right, transparent, rgba(245,158,11,0.35))' }} />
            <div className="h-1.5 w-1.5 rotate-45 bg-amber-500 shadow-[0_0_8px_rgba(245,158,11,0.5)]" />
            <div className="h-px flex-1" style={{ background: 'linear-gradient(to left, transparent, rgba(245,158,11,0.35))' }} />
          </div>
